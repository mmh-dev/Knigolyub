...
interface BookMapper {
    ...
    class Base(
        ...
        override fun <T> map(mapper: Mapper<T>): T = mapper.map(author = author,
            id = id,
            page = page,
    ...
    class ComplexMapper(private val booksMapper: BookMapper) : BookThatReadMapper.Mapper<BookThatReadData> {
        override fun map(
            progress: Int,
            objectId: String,
            createdAt: Date,

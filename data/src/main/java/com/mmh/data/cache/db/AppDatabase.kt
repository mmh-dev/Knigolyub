...
@Database(entities = [BookCache::class, BookThatReadCache::class, ClassCache::class, UserCache::class], version = 1)
...
abstract class AppDatabase : RoomDatabase() {
    ...
    class DatabaseConverter {
        ...
        fun toUserImageCache(source: String): UserImageCache {
            val json = JSONObject(source)
            return UserImageCache(name = json.getString("userImageCache.name"),

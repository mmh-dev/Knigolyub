...
interface BooksCacheDataSource {
    ...
    class Base(
        ...
        override suspend fun updateTitle(id: String, title: String) = bookDao.updateBookTitle(id = id, title = title)

        override suspend fun updateAuthor(id: String, author: String) = bookDao.updateBookAuthor(id = id, author = author)

        override suspend fun updatePublicYear(id: String, publicYear: String) = bookDao.updateBookPublicYear(publicYear = publicYear, id = id)

        override suspend fun updatePoster(id: String, poster: BookPosterDomain) =
            bookDao.updateBookPoster(poster = BookPosterCache(name = poster.name, url = poster.url), id = id)

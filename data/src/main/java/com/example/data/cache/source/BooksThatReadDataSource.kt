...
interface BooksThatReadDataSource {
    ...
    class Base(
        ...
        override suspend fun fetchBooksThatRead(): List<BookThatReadCache> = dao.getAllBooks()
        ...
        override suspend fun updateProgress(id: String, progress: Int) = dao.updateProgress(progress, id = id)

        override suspend fun updateChapters(id: String, chapters: Int) = dao.updateChapters(chapters = chapters, id = id)

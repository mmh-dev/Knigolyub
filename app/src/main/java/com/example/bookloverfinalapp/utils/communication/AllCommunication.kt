...
interface SchoolProgressCommunication : Communication<FragmentSchoolProgressViewModel.SchoolProgress> {
    class Base : Communication.Base<FragmentSchoolProgressViewModel.SchoolProgress>(), SchoolProgressCommunication
}
...
interface ClassStatisticsCommunication : Communication<FragmentProgressViewModel.ClassStatistics> {
    class Base : Communication.Base<FragmentProgressViewModel.ClassStatistics>(), ClassStatisticsCommunication
}

...
class ClassHasDeletedViewModel @Inject constructor(
    ...
    fun collect(owner: LifecycleOwner, observer: Observer<List<SchoolClass>>) = communication.observe(owner = owner, observer = observer)
    ...
    fun updateStudentClass(
        ...
        updateStudentClassUseCase.execute(id = id, sessionToken = sessionToken, classId = classId, classTitle = classTitle)

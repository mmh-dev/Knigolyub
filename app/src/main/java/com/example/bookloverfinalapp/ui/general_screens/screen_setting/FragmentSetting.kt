...
class FragmentSetting : PreferenceFragmentCompat() {
    ...
    override fun onCreateView(
        ...
        val languagePreference = preferenceManager.findPreference<Preference>(SETTING_LANGUAGE_KEY) as ListPreference
        val modePreference = preferenceManager.findPreference<Preference>(SETTING_THEME_KEY) as SwitchPreference

        modePreference.onPreferenceChangeListener = Preference.OnPreferenceChangeListener { _, newValue ->

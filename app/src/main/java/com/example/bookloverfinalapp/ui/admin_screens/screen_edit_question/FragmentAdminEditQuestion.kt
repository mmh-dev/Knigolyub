...
class FragmentAdminEditQuestion :
    BaseFragment<FragmentAdminEditQuestionBinding, FragmentAdminEditQuestionViewModel>(FragmentAdminEditQuestionBinding::inflate),
    ...
    override fun onClick(view: View?) {
        when (view) {
            binding().answerAButton -> showCustomInputAlertDialog(binding().answerAButton, binding().answerAButton.text.toString())
            binding().answerBButton -> showCustomInputAlertDialog(binding().answerBButton, binding().answerBButton.text.toString())
            binding().answerCButton -> showCustomInputAlertDialog(binding().answerCButton, binding().answerCButton.text.toString())
            binding().answerDButton -> showCustomInputAlertDialog(binding().answerDButton, binding().answerDButton.text.toString())
    ...
    private fun chekUpdate() {
        binding().apply {
            ...
            if (answerAButton.text.toString() != question.a || answerBButton.text.toString() != question.b || answerCButton.text.toString() != question.c || answerDButton.text.toString() != question.d || rightAnswer != question.rightAnswer || questionText.text.toString() != question.question) updateQuestion(
                rightAnswer)
    ...
    private fun updateQuestion(rightAnswer: String) {
        binding().apply {
            val updateQuestion = AddBookQuestion(question = questionText.text.toString(),

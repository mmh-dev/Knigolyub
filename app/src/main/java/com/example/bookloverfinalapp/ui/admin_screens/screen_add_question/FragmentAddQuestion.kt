...
@AndroidEntryPoint
class FragmentAddQuestion : BaseFragment<FragmentAddQuestionBinding, FragmentAddQuestionViewModel>(FragmentAddQuestionBinding::inflate),
        ...
        binding().apply {
            when {
                ...
                questionText.text.isBlank() -> showToast(R.string.fill_in_all_fields)
                    ...
                    val question = AddBookQuestion(question = questionText.text.toString(),

...
class FragmentSignUpViewModel @Inject constructor(
    ...
    fun signUp(user: UserSignUpDomain) = liveData(context = viewModelScope.coroutineContext + dispatchersProvider.io()) {
    ...
    fun addSessionToken(id: String, sessionToken: String) = liveData(context = viewModelScope.coroutineContext + dispatchersProvider.io()) {
    ...
    fun goStudentToLoginFragment() = navigate(FragmentSignUpStudentDirections.actionFragmentSignUpStudentToFragmentLogin())

    fun goTeacherToLoginFragment() = navigate(FragmentSignUpTeacherDirections.actionFragmentSignUpTeacherToFragmentLogin())

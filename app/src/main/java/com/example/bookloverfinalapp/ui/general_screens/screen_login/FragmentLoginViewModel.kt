...
class FragmentLoginViewModel @Inject constructor(
    ...
    fun signInWithEmailUseCase(email: String, password: String) = liveData(context = viewModelScope.coroutineContext) {
    ...
    fun goOverSignUpFragment() = navigate(FragmentLoginDirections.actionFragmentLoginToFragmentSignUp())

    fun goForgotPasswordFragment() = navigate(FragmentLoginDirections.actionFragmentLoginToFragmentForgotPassword())

...
class FragmentGenreSimilarBooksViewModel @Inject constructor(
    ...
    fun fetchSimilarBook(genre: String) = launchInBackground {
        ...
        genres.add(genre)
        getSimilarBooksUseCase.execute(genres = genres, bookId = "0").collectLatest { resource ->
    ...
    fun goBookInfoFragment(book: Book) = navigate(FragmentGenreSimilarBooksDirections.actionFragmentGenreSimilarBooksToFragmentBookInfo(book = book))

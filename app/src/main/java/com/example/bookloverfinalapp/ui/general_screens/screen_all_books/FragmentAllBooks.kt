...
@AndroidEntryPoint
class FragmentAllBooks : BaseFragment<FragmentAllBooksBinding, FragmentAllBooksViewModel>(FragmentAllBooksBinding::inflate),
    SwipeRefreshLayout.OnRefreshListener, SearchView.OnQueryTextListener, ItemOnClickListener {

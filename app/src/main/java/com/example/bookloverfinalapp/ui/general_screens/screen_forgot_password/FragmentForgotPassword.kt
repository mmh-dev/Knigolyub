...
@AndroidEntryPoint
class FragmentForgotPassword : BaseFragment<FragmentForgotPasswordBinding, FragmentForgotPasswordViewModel>(FragmentForgotPasswordBinding::inflate) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding().apply {
            ...
            sendMessage.setOnClickListener {
                ...
                else viewModel.passwordReset(email = emailField.text.toString()).observe(viewLifecycleOwner) {

...
@AndroidEntryPoint
class FragmentStudentDetails : BaseFragment<FragmentStudentDetailsBinding, FragmentStudentDetailsViewModel>(FragmentStudentDetailsBinding::inflate),
    ItemOnClickListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding().deleteProfileButton.setOnClickListener {
            val listener = DialogInterface.OnClickListener { _, which ->
                when (which) {
                    DialogInterface.BUTTON_POSITIVE -> viewModel.deleteStudent(id = student.objectId, sessionToken = student.sessionToken)
            ...
            val dialog = AlertDialog.Builder(requireContext()).setTitle(R.string.login_out_title).setCancelable(true)
                .setMessage(R.string.default_delete_user_alert_message).setPositiveButton(R.string.action_yes, listener)

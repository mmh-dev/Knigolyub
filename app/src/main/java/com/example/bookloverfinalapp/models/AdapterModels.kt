...
import com.example.bookloverfinalapp.app.ui.adapter.GenericViewHolder.Companion.VIEW_POSITION_SECOND
import com.example.bookloverfinalapp.app.ui.adapter.GenericViewHolder.Companion.VIEW_POSITION_SEVENTH
import com.example.bookloverfinalapp.app.ui.adapter.GenericViewHolder.Companion.VIEW_POSITION_SIXTH
import com.example.bookloverfinalapp.app.ui.adapter.GenericViewHolder.Companion.VIEW_POSITION_THIRD
import com.example.bookloverfinalapp.app.ui.adapter.GenericViewHolder.Companion.VIEW_POSITION_ZERO
...
data class BookThatReadModel(
    ...
    private fun getCreatedAt(context: Context): String {
        val language = PreferenceManager.getDefaultSharedPreferences(context).getString(SETTING_LANGUAGE_KEY, SETTING_LANGUAGE_ENGLISH_KEY)
...
data class UserTypeModel(val userType: UserType) : ItemUi {
    ...
    override fun show(vararg views: CustomView, context: Context, position: Int) {
        val type = if (userType == UserType.teacher) context.getString(R.string.teachers)

...
object ServiceModule {
    ...
    @Provides
    @Singleton
    fun provideBookThatReadService(retrofit: Retrofit): BookThatReadService = retrofit.create(BookThatReadService::class.java)
    ...
    @Provides
    @Singleton
    fun provideClassService(retrofit: Retrofit): ClassService = retrofit.create(ClassService::class.java)

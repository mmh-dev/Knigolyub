...
object AppModule {
    ...
    @Provides
    @Singleton
    fun provideProgressDialogCommunication(): ProgressDialogCommunication = ProgressDialogCommunication.Base()
    ...
    @Provides
    fun provideGetCurrentUserUseCase(repository: UserRepository): GetCurrentUserUseCase = GetCurrentUserUseCase(repository = repository)


    @Provides
    fun provideClearClassCacheUseCase(repository: ClassRepository): ClearClassCacheUseCase = ClearClassCacheUseCase(repository = repository)

    @Provides
    fun provideClearStudentsCacheUseCase(repository: UserRepository): ClearStudentsCacheUseCase = ClearStudentsCacheUseCase(repository = repository)
    ...
    @Provides
    fun provideClearBooksCacheUseCase(repository: BooksRepository): ClearBooksCacheUseCase = ClearBooksCacheUseCase(repository = repository)

    @Provides
    fun provideGetClassUseCase(repository: ClassRepository): GetClassUseCase = GetClassUseCase(repository = repository)

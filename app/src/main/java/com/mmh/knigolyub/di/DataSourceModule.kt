...
object DataSourceModule {
    ...
    ): BooksCloudDataSource = BooksCloudDataSource.Base(
        service = service,
    ...
    fun provideBookCloudDataSource(
        ...
        resourceProvider: ResourceProvider,
    ): BooksThatReadCloudDataSource = BooksThatReadCloudDataSource.Base(thatReadService = thatReadService, resourceProvider = resourceProvider)
    ...
    ): BooksCacheDataSource = BooksCacheDataSource.Base(bookDao = dao, dataMapper = mapper, bookThatReadDao = bookDao)
    ...
    ): BooksThatReadDataSource = BooksThatReadDataSource.Base(mapper = mapper, dao = dao)
    ...
    ): ClassCloudDataSource = ClassCloudDataSource.Base(service = service, resourceProvider = resourceProvider, mapper = mapper)

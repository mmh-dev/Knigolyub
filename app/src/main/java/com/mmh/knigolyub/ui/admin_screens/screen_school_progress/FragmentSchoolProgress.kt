...
@AndroidEntryPoint
class FragmentSchoolProgress : BaseFragment<FragmentSchoolProgressBinding, FragmentSchoolProgressViewModel>(FragmentSchoolProgressBinding::inflate) {
    ...
    private fun showStudentSingleChoiceWithConfirmationAlertDialog(list: List<String>) {
        val dialog = AlertDialog.Builder(requireContext()).setTitle(R.string.student_setup)
            .setSingleChoiceItems(list.toTypedArray(), studentCurrentIndex, null).setPositiveButton(R.string.action_confirm) { d, _ ->
                val index = (d as AlertDialog).listView.checkedItemPosition

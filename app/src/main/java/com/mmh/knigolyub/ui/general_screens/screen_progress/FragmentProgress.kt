...
@AndroidEntryPoint
class FragmentProgress : BaseFragment<FragmentProgressBinding, FragmentProgressViewModel>(FragmentProgressBinding::inflate), ItemOnClickListener {
    ...
    private fun showFilterAlertDialog() {
        ...
        val dialog = AlertDialog.Builder(requireContext()).setView(dialogBinding.root).setTitle(R.string.select_display_mode)
    ...
    private fun setupUi() {
        ...
        binding().apply {
            ...
            currentUser.apply {
                ...
                Glide.with(requireActivity()).load(image?.url).placeholder(R.drawable.placeholder_avatar).into(studentProgressImg)
            }
        }
    }

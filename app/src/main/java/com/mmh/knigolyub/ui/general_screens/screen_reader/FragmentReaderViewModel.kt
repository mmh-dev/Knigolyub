...
class FragmentReaderViewModel @Inject constructor(
    ...
    fun updateProgress(
        ...
        updateProgressStudentBookUseCase.execute(id = id, progress = progress).collectLatest { resource ->
    ...
    fun goQuestionFragment(book: BookThatRead, chapter: Int, path: String) =
        navigate(FragmentReaderDirections.actionStudentFragmentReaderToFragmentBookQuestion(book = book, chapter = chapter, path = path))

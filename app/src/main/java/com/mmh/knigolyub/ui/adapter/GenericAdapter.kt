...
class GenericAdapter(private val actionListener: ItemOnClickListener) : RecyclerView.Adapter<GenericViewHolder>(), Mapper<List<ItemUi>, Unit> {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): GenericViewHolder = ViewHolderChain().execute(viewType, parent, actionListener)

    override fun onBindViewHolder(holder: GenericViewHolder, position: Int) = holder.bind(itemList[position])

...
@AndroidEntryPoint
class FragmentSignUpStudent : BaseFragment<FragmentSignUpStudentBinding, FragmentSignUpViewModel>(FragmentSignUpStudentBinding::inflate),
    ...
    private fun signUp() {
        binding().apply {
            if (!lastNameField.validateName()) showToast(message = getString(R.string.last_name_input_format_error))
                ...
                val studentDto = UserSignUpDomain(name = firstNameField.text.toString(),
    ...
    private fun showClassSingleChoiceWithConfirmationAlertDialog() {
        val dialog = AlertDialog.Builder(requireContext()).setTitle(R.string.class_setup)
            .setSingleChoiceItems(classesTitleList.toTypedArray(), classCurrentIndex, null).setPositiveButton(R.string.action_confirm) { d, _ ->
    ...
    private fun showSchoolSingleChoiceWithConfirmationAlertDialog() {
        val dialog = AlertDialog.Builder(requireContext()).setTitle(R.string.volume_school_setup)
            .setSingleChoiceItems(schoolTitleList.toTypedArray(), schoolCurrentIndex, null).setPositiveButton(R.string.action_confirm) { d, _ ->
                val index = (d as AlertDialog).listView.checkedItemPosition

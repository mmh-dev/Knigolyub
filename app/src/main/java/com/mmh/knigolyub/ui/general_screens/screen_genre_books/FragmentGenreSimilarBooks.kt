...
class FragmentGenreSimilarBooks :
    BaseFragment<FragmentGenreSimilarBooksBinding, FragmentGenreSimilarBooksViewModel>(FragmentGenreSimilarBooksBinding::inflate),
    ItemOnClickListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        with(binding()) {
            ...
            titleBar.title = GenresManager.getGenreByCloudCode(context = requireContext(), code = genre)

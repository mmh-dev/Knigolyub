...
class ActivityClassHasDeleted : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.confimButton.setOnClickListener {
            when {
                ...
                else -> viewModel.updateStudentClass(id = currentUser.id,
    ...
    private fun showClassSingleChoiceWithConfirmationAlertDialog(list: List<String>) {
        val dialog = AlertDialog.Builder(this).setTitle(R.string.class_setup).setSingleChoiceItems(list.toTypedArray(), classCurrentIndex, null)

...
class FragmentAdminEditProfile :
    BaseFragment<FragmentAdminEditProfileBinding, FragmentAdminEditProfileViewModel>(FragmentAdminEditProfileBinding::inflate), View.OnClickListener {
    ...
    private fun checkChanges() {
        binding().apply {
            if (editStudentName.text.toString() == admin.name && editStudentLastName.text.toString() == admin.lastname && editStudentEmail.text.toString() == admin.email && editStudentNumber.text.toString() == admin.number && gender == admin.gender && parseFile == null) return@apply
            else checkImage()
        }
    }
    ...
    private fun updateStudent() {
        binding().apply {
            val student = UserUpdateDomain(gender = gender,
                ...
                image = image!!.toDto())
            viewModel.updateAdmin(id = this@FragmentAdminEditProfile.admin.id, user = student, sessionToken = currentUser.sessionToken)
    ...
    private fun successUpdated() {
        binding().apply {
            val newStudent = User(gender = gender,
                name = editStudentName.text.toString(),
                lastname = editStudentLastName.text.toString(),
                email = editStudentEmail.text.toString(),

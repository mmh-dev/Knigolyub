...
@AndroidEntryPoint
class FragmentLogin : BaseFragment<FragmentLoginBinding, FragmentLoginViewModel>(FragmentLoginBinding::inflate), View.OnClickListener {
    ...
    private fun signIn() {
        ...
        viewModel.signInWithEmailUseCase(email = email, password = password).observe(viewLifecycleOwner) { user ->

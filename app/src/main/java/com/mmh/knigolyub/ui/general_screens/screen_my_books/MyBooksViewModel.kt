...
class MyBooksViewModel @Inject constructor(
    ...
    fun bookObserve(owner: LifecycleOwner, observer: Observer<List<BookThatRead>>) = bookCommunication.observe(owner = owner, observer = observer)
    ...
    fun listIsEmpty() = launchInBackground { communication.put(listOf(CatEmptyModel)) }

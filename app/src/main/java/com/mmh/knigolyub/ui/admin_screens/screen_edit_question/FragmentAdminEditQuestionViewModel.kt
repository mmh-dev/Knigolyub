...
class FragmentAdminEditQuestionViewModel @Inject constructor(
    ...
    fun updateQuestion(id: String, question: AddBookQuestion) = liveData(context = viewModelScope.coroutineContext + dispatchersProvider.io()) {
        updateBookQuestionUseCase.execute(question = mapper.map(question), id = id).collectLatest { resource ->

...
@AndroidEntryPoint
class FragmentEditProfile : BaseFragment<FragmentEditProfileBinding, FragmentEditProfileViewModel>(FragmentEditProfileBinding::inflate),
    ...
    private fun checkChanges() {
        binding().apply {
            if (editStudentName.text.toString() == user.name && editStudentLastName.text.toString() == user.lastname && editStudentEmail.text.toString() == user.email && editStudentNumber.text.toString() == user.number && gender == user.gender && parseFile == null) return@apply
            else checkImage()
        }
    }
    ...
    private fun updateStudent() {
        binding().apply {
            val student = UserUpdateDomain(gender = gender,
                ...
                image = image!!.toDto())
            viewModel.updateStudent(id = this@FragmentEditProfile.user.id, user = student, sessionToken = currentUser.sessionToken)

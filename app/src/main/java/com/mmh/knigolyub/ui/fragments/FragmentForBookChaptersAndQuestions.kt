 ...
 * Use the [FragmentForBookChaptersAndQuestions.newInstance] factory method to
...
class FragmentForBookChaptersAndQuestions : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment FragmentForBookChaptersAndQuestions.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            FragmentForBookChaptersAndQuestions().apply {

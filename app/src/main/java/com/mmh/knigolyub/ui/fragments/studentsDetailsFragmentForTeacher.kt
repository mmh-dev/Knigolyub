 ...
 * Use the [studentsDetailsFragmentForTeacher.newInstance] factory method to
...
class studentsDetailsFragmentForTeacher : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment studentsDetailsFragmentForTeacher.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            studentsDetailsFragmentForTeacher().apply {

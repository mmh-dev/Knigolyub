...
class SharedPreferences {
    ...
    fun saveCurrentUser(
        ...
        activity.getSharedPreferences(CURRENT_STUDENT_EDITOR_SAVE_KEY, Context.MODE_PRIVATE).edit()
            .putString(CURRENT_STUDENT_SAVE_KEY, Gson().toJson(user)).apply()
    }
    ...
    fun saveIsFilter(
        ...
        context.getSharedPreferences(IS_FILTER_EDITOR_SAVE_KEY, Context.MODE_PRIVATE).edit().putBoolean(IS_FILTER_SAVE_KEY, isFilter).apply()
    }
